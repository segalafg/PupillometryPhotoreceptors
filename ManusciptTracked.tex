...
%DIF DEL manuscriptold.tex   Mon Aug  5 10:44:25 2024
%DIF ADD manuscript.tex      Thu Nov 28 14:50:40 2024
...
%DIF 75c75
%DIF < \usepackage{caption} \usepackage{setspace}\doublespacing \usepackage{lineno} \linenumbers
%DIF -------
\usepackage{caption} \usepackage{setspace}\doublespacing \usepackage{lineno} \linenumbers \newcommand{\beginsupplement}{\setcounter{table}{0} \renewcommand{\thetable}{S\arabic{table}} \setcounter{figure}{0} \renewcommand{\thefigure}{S\arabic{figure}}} %DIF > 
%DIF -------
\usepackage{booktabs}
...
\DIFdelbegin \DIFdel{In the luminance }\DIFdelend \DIFaddbegin \DIFadd{Silent substitution stimuli were prepared and calibrated for each participant with custom Python software (Martin et al., }\protect\hyperlink{ref-Martin2023}{2023}\DIFadd{) and Python scripts. Estimates of photoreceptor spectral sensitivities for each participant were constructed from the known photopigment absorbance spectra (Stockman and Sharpe, }\protect\hyperlink{ref-Stockman2000}{2000}\DIFadd{), taking account of the peak axial density of the respective photopigments, as well as lens (Pokorny et al., }\protect\hyperlink{ref-Pokorny1987}{1987}\DIFadd{; Stockman et al., }\protect\hyperlink{ref-Stockman1999}{1999}\DIFadd{; Stockman and Sharpe, }\protect\hyperlink{ref-Stockman2000}{2000}\DIFadd{) and macular pigment density (Bone et al., }\protect\hyperlink{ref-Bone1988}{1988}\DIFadd{; Stockman et al., }\protect\hyperlink{ref-Stockman1999}{1999}\DIFadd{), in accordance with the field size and age-dependant CIEPO06 observer model (CIE, }\protect\hyperlink{ref-CIE2006}{2006}\DIFadd{). The melanopic and rhodopic action spectra of the 32-year-old standard observer were taken from CIE S 026 (CIE, }\protect\hyperlink{ref-CIE2018}{2018}\DIFadd{) and then adjusted for age-related lens transmittance with a spectral correction function, in line with the standard. Macular pigment correction was not applied to the rhodopic and melanopic action spectra because rods are not present at the fovea and ipRGCs sit above the retinal pigment layer (Trieschmann et al., }\protect\hyperlink{ref-Trieschmann2007}{2007}\DIFadd{).
}

\DIFadd{In the light flux }\DIFaddend experiment, the stimulus intensity was increased and decreased relative to the background, which we expected to modulate all photoreceptor classes (see Figure \ref{fig:spectraplots}e,i). In the L-M cone modulation experiment, we used silent \DIFdelbegin \DIFdel{substution }\DIFdelend \DIFaddbegin \DIFadd{substitution }\DIFaddend to increase the L-cone activity, and simultaneously decrease the M-cone activity, during the first half-cycle of the sine wave. In the second half-cycle the polarity of the modulation reversed (see Figure \ref{fig:spectraplots}f,j). The maximum available L-M contrast was approximately 10\%. In the S-cone modulation experiment, we increased and decreased S-cone-directed signals, whilst keeping activity in the other photoreceptors constant (see Figure \ref{fig:spectraplots}g,k). Our system allowed a maximum contrast of 45\%. Finally, in the melanopsin experiment, we modulated the activity of the melanopsin-containing intrinsically photoreceptive retinal ganglion cells, whilst keeping cone activity constant (see Figure \ref{fig:spectraplots}h,l). The maximum available melanopsin contrast was 22\%. We assume that the activity of rods was constant at the high background luminance intensity used here, and so did not attempt to silence rod activity in any condition, as this would have greatly reduced the available dynamic range. Splatter on nominally silenced photoreceptors was very small (see Figure \ref{fig:spectraplots}j-l), well below the levels that would be expected to generate \DIFdelbegin \DIFdel{measureable pupil modulations}\DIFdelend \DIFaddbegin \DIFadd{measurable pupil modulations, although we can observe that the rods may not be saturated in the L-M and melanopsin-directed stimuli (Figure \ref{fig:spectraplots}j and \ref{fig:spectraplots}l) and could intrude in these two experiments}\DIFaddend . We also estimated activation of penumbral L and M cones (Spitschan et al., \protect\hyperlink{ref-Spitschan2015}{2015}; Barrionuevo and Cao, \protect\hyperlink{ref-Barrionuevo2016}{2016}; Zele et al., \protect\hyperlink{ref-Zele2019}{2019}), which was minimal (\(\le 1.5%
...
Figure \ref{fig:spectraplots}m-p shows averaged waveforms of pupil diameter in response to binocular stimulation. For \DIFdelbegin \DIFdel{luminance }\DIFdelend \DIFaddbegin \DIFadd{light flux }\DIFaddend stimuli (Figure \ref{fig:spectraplots}m) a strong modulation is apparent at the stimulation frequency (0.5Hz), which is also clear in the Fourier amplitude spectrum (Figure \ref{fig:spectraplots}q). For binocular stimulation of the L-M pathway, S-cone pathway and melanopsin pathway, pupil modulations were less than 10\% of the amplitude of the \DIFdelbegin \DIFdel{luminance }\DIFdelend \DIFaddbegin \DIFadd{light flux }\DIFaddend modulation (note the change in y-axis scale for the Fourier spectra), but still apparent at 0.5Hz in the Fourier spectra (Figure \ref{fig:spectraplots}n-p). We also observed a second harmonic response (at 1Hz) for all conditions, which was weaker than the first harmonic for \DIFdelbegin \DIFdel{luminance }\DIFdelend \DIFaddbegin \DIFadd{light flux }\DIFaddend and melanopsin stimulation, but stronger for L-M and S-cone stimulation. The second harmonic is also apparent in the pupil waveforms shown in Figure \ref{fig:spectraplots}n-p.~Our main analysis therefore focuses on the amplitude of the pupil modulations at both the first and second harmonic frequencies across different stimulus conditions.

\begin{figure}

{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.8\linewidth]{Figures/methodsfig} 
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.8\linewidth]{Figures/methodsfigrods} 
\DIFaddendFL 
...
\midrule
\DIFdelbeginFL \DIFdelFL{Luminance }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Light flux }\DIFaddendFL 1F & 95.77 & 0.00083 & 0.37 & 1.32 & 1.24 & 0.0905\\
...
\midrule
\DIFdelbeginFL \DIFdelFL{Luminance }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Light flux }\DIFaddendFL 2F & 48.81 & 0.00089 & 1.24 & 1.15 & 0.88 & 0.0039\\
...
Finally, we inspected the response phase of our four stimulation conditions, given previous reports that these differ across pathways (Spitschan et al., \protect\hyperlink{ref-Spitschan2014}{2014}), and may be in antiphase for melanopsin and S-cone signals. Figure \ref{fig:phaseplots} shows the phase angles for the first (a) and second (b) harmonic frequencies for binocular stimulation (monocular stimulation produced very similar results). At the first harmonic, melanopsin and S-cone signals differed in phase by more than 90 degrees, though they were not fully in antiphase. The \DIFdelbegin \DIFdel{luminance }\DIFdelend \DIFaddbegin \DIFadd{light flux }\DIFaddend and L-M responses were approximately in antiphase to each other, however this is likely due to our choice to modulate L+M- in the first half-cycle of the sine wave (corresponding to a luminance increase in the \DIFdelbegin \DIFdel{luminance }\DIFdelend \DIFaddbegin \DIFadd{light flux }\DIFaddend condition), and L-M+ in the second half-cycle (corresponding to a luminance decrease in the \DIFdelbegin \DIFdel{luminance }\DIFdelend \DIFaddbegin \DIFadd{light flux }\DIFaddend condition). Had we reversed this phase arrangement, we would likely have seen a close phase correspondence between the L-M and \DIFdelbegin \DIFdel{luminance }\DIFdelend \DIFaddbegin \DIFadd{light flux }\DIFaddend conditions (another way to think about this is that L-cone decreases and M-cone increases are processed like luminance increases). Phase differences between the \DIFdelbegin \DIFdel{luminance}\DIFdelend \DIFaddbegin \DIFadd{light flux}\DIFaddend , S-cone and melanopsin conditions are likely attributable to different lags in phototransduction at the earliest stage (i.e.~in the retina). At the second harmonic frequency (Figure \ref{fig:phaseplots}b), the \DIFdelbegin \DIFdel{luminance }\DIFdelend \DIFaddbegin \DIFadd{light flux }\DIFaddend condition was again out of phase with the other three, and was approximately in quadrature phase with the L-M condition, and in antiphase with both the S-cone and melanopsin conditions (which were in phase with each other).
...
\leavevmode\DIFaddbegin \hypertarget{ref-Bone1988}{}%DIF > 
\DIFadd{Bone RA, Landrum JT, Fernandez L, Tarsis SL (1988) Analysis of the macular pigment by HPLC: Retinal distribution and age study. Investigative Ophthalmology \& Visual Science 29:843--849.
}

\leavevmode\DIFaddend \hypertarget{ref-Busse2009}{}%
...
\leavevmode\DIFaddbegin \hypertarget{ref-CIE2006}{}%DIF > 
\DIFadd{CIE (2006) Fundamental chromaticity diagram with physiological axes. CIE Central Bureau. Available at: }\url{https://cie.co.at/publications/fundamental-chromaticity-diagram-physiological-axes-part-1}\DIFadd{.
}

\leavevmode\hypertarget{ref-CIE2018}{}%DIF > 
\DIFadd{CIE (2018) CIE system for metrology of optical radiation for ipRGC-influenced responses to light. CIE Central Bureau. Available at: }\url{https://doi.org/10.25039/S026.2018}\DIFadd{.
}

\leavevmode\DIFaddend \hypertarget{ref-Dacey2003}{}%
...
\leavevmode\DIFaddbegin \hypertarget{ref-Pokorny1987}{}%DIF > 
\DIFadd{Pokorny J, Smith VC, Lutze M (1987) Aging of the human lens. Applied Optics 26:1437 Available at: }\url{http://dx.doi.org/10.1364/AO.26.001437}\DIFadd{.
}

\leavevmode\DIFaddend \hypertarget{ref-Provencio2000}{}%
...
\leavevmode\DIFaddbegin \hypertarget{ref-Stockman1999}{}%DIF > 
\DIFadd{Stockman A, Sharpe LT, Fach C (1999) The spectral sensitivity of the human short-wavelength sensitive cones derived from thresholds and color matches. Vision Research 39:2901--2927 Available at: }\url{https://www.sciencedirect.com/science/article/pii/S0042698998002259}\DIFadd{.
}

\leavevmode\hypertarget{ref-Trieschmann2007}{}%DIF > 
\DIFadd{Trieschmann M, Kuijk FJGM van, Alexander R, Hermans P, Luthert P, Bird AC, Pauleikhoff D (2007) Macular pigment in the human retina: Histological evaluation of localization and distribution. Eye 22:132--137 Available at: }\url{http://dx.doi.org/10.1038/sj.eye.6702780}\DIFadd{.
}

\leavevmode\DIFaddend \hypertarget{ref-Woelders2018}{}%
