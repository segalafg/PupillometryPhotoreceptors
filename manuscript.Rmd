...
# (download and) analyse individual participant data for the luminance condition
if (processdata > 2){

  for(p in 601:612){
    participant <- paste0('P',p)
    ...
    repcounterP <- (1:60)*0
    d <- dir(paste0(rawdir,participant),pattern='*annotations.csv',full.names=TRUE)

    for (block in 1:length(d)){
        tic()
        adata <- read.csv(paste0(rawdir,participant,'/',paste0(participant,'_S',block),'_annotations.csv'))
        ...
        pdata <- read.csv(paste(rawdir,participant,'/',paste0(participant,'_S',block),'_pupil_positions.csv',sep=''))
    ...
    save(file=paste(datadir,participant,'_summaryLum.RData',sep=''),list=c('cleanmeansP','cleanmasksP','cleanmeansP2','cleanmasksP2','meanspectraP','meanwavesP'))
  }
...
# (download and) analyse individual participant data for the melanopsin condition
if (processdata > 2){
  ...
  for(p in 501:512){
    ...
    meanwavesP <- apply(pupilwaveforms[,,c(15,20),],4,mean,na.rm=TRUE)
    meanspectraP <- apply(pupilspectra[,,c(15,20),],4,mean,na.rm=TRUE)
    save(file=paste(datadir,participant,'_summaryMel.RData',sep=''),list=c('cleanmeansP','cleanmasksP','cleanmeansP2','cleanmasksP2','meanspectraP','meanwavesP'))
    }
  }
```
...
# (download and) analyse individual participant data for the L-M condition
if (processdata > 2){
  ...
  for(p in 701:712){
    ...
    meanwavesP <- apply(pupilwaveforms[,,c(15,20),],4,mean,na.rm=TRUE)
    meanspectraP <- apply(pupilspectra[,,c(15,20),],4,mean,na.rm=TRUE)
    save(file=paste(datadir,participant,'_summaryLM.RData',sep=''),list=c('cleanmeansP','cleanmasksP','cleanmeansP2','cleanmasksP2','meanspectraP','meanwavesP'))
  }
...
if (processdata > 2){
  ...
  for(p in 301:312){
    ...
    meanwavesP <- apply(pupilwaveforms[,,c(15,20),],4,mean,na.rm=TRUE)
    meanspectraP <- apply(pupilspectra[,,c(15,20),],4,mean,na.rm=TRUE)
    save(file=paste(datadir,participant,'_summaryS.RData',sep=''),list=c('cleanmeansP','cleanmasksP','cleanmeansP2','cleanmasksP2','meanspectraP','meanwavesP'))
  }
