...
coneab <- read.csv('local/coneabsorptions.csv',header=FALSE)
spectra <- read.csv('local/spectra.csv',header=FALSE)
...
par(mar=c(1.5,1,0.1,0.1))
  ...
  schematic <- readTIFF('local/schematic.tiff')
...
lspec <- read.csv('local/STLAB_1_oo_irrad_spectra.csv',header=FALSE)
rspec <- read.csv('local/STLAB_2_oo_irrad_spectra.csv',header=FALSE)
...
plotlims <- c(-24,24,-24,24) 
ticklocsx <- seq(-24,24,12)    
ticklocsy <- seq(-24,24,12)      
ticklabelsx <- c('1/16','1/4','1','4','16')        
ticklabelsy <- ticklabelsx    # set labels for y ticks
...
points(allbin[1:4,5],alldich[1:4,5],pch=21)
...
points(allbin[5:8,5],alldich[5:8,5],pch=21)
