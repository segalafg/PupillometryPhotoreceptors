...
author: |
 | Federico G. Segala$^1$, Aurelio Bruno$^{1,2}$, Joel T. Martin$^{1,3}$, Annie Y. Morsi$^1$, Alex R. Wade$^{1,4}$
 | & Daniel H. Baker$^{1,4}$
output:
...
if (processdata > 2){
  ...
  #     if (!file.exists(paste0(rawdir,'P',600+participant,'_S1_annotations.csv'))){
  #       
  ...
  #        unzip(paste0(rawdir,'P',600+participant,'.zip'), exdir=rawdir, overwrite=TRUE)
  #        
  ...
  #   
  #   # if there is no directory for this participant's data
  #     if (!file.exists(paste0(rawdir,'P',500+participant,'_S1_annotations.csv'))){
  #       
  #        # if the tar file of this participant's data doesn't exist
  ...
  #        
  #        # then unzip the zip file
  #        unzip(paste0(rawdir,'P',500+participant,'.zip'), exdir=rawdir, overwrite=TRUE)
  #        
  #        # and delete the tar file to save storage space
  ...
  #   
  #   # if there is no directory for this participant's data
  #     if (!file.exists(paste0(rawdir,'P',700+participant,'_S1_annotations.csv'))){
  #       
  #        # if the tar file of this participant's data doesn't exist
  ...
  #        
  #        # then unzip the zip file
  #        unzip(paste0(rawdir,'P',700+participant,'.zip'), exdir=rawdir, overwrite=TRUE)
  #        
  #        # and delete the tar file to save storage space
  ...
  #   
  #   # if there is no directory for this participant's data
  #     if (!file.exists(paste0(rawdir,'P',300+participant,'_S1_annotations.csv'))){
  #       
  #        # if the tar file of this participant's data doesn't exist
  ...
  #        
  #        # then unzip the zip file
  #        unzip(paste0(rawdir,'P',300+participant,'.zip'), exdir=rawdir, overwrite=TRUE)
  #        
  #        # and delete the tar file to save storage space
...
if (processdata > 1){
  ...
  # if there is no directory for this participant's data
      if (!file.exists(paste0(datadir,pattern='_summary.RData'))){

         # if the tar file of this participant's data doesn't exist
         if (!file.exists(paste0(datadir,'IndividualSummary.zip'))){
           # download it from OSF
           if (!exists('osffiles')){
           osfnode <- '9ebtd'
           osfproject <- osf_retrieve_node(osfnode)
          osffiles <- osf_ls_files(osfproject,n_max=300)}
          fid <- which(osffiles$name==paste0('IndividualSummary.zip'))
          osf_download(osffiles[fid,],datadir,progress=TRUE)
         }

         # then unzip the zip file
         unzip(paste0(datadir,'IndividualSummary.zip'), exdir=datadir, overwrite=TRUE)

         # and delete the tar file to save storage space
         file.remove(paste0(datadir,'IndividualSummary.zip'))
         file.remove(paste0(datadir,'__MACOSX'))
      }
...
if (!file.exists(paste0(datadir,'modeloutputLum.RData'))){
  if (!exists('osffiles')){
    osfnode <- '9ebtd'
    osfproject <- osf_retrieve_node(osfnode)
    osffiles <- osf_ls_files(osfproject,n_max=300)
  }
  fid <- which(osffiles$name==paste0('modeloutputLum.RData'))
  osf_download(osffiles[fid,],datadir,progress=TRUE)
}

if (!file.exists(paste0(datadir,'modeloutputLM.RData'))){
  if (!exists('osffiles')){
    osfnode <- '9ebtd'
    osfproject <- osf_retrieve_node(osfnode)
    osffiles <- osf_ls_files(osfproject,n_max=300)
  }
  fid <- which(osffiles$name==paste0('modeloutputLM.RData'))
  osf_download(osffiles[fid,],datadir,progress=TRUE)
}

if (!file.exists(paste0(datadir,'modeloutputMel.RData'))){
  if (!exists('osffiles')){
    osfnode <- '9ebtd'
    osfproject <- osf_retrieve_node(osfnode)
    osffiles <- osf_ls_files(osfproject,n_max=300)
  }
  fid <- which(osffiles$name==paste0('modeloutputMel.RData'))
  osf_download(osffiles[fid,],datadir,progress=TRUE)
}

if (!file.exists(paste0(datadir,'modeloutputS.RData'))){
  if (!exists('osffiles')){
    osfnode <- '9ebtd'
    osfproject <- osf_retrieve_node(osfnode)
    osffiles <- osf_ls_files(osfproject,n_max=300)
  }
  fid <- which(osffiles$name==paste0('modeloutputS.RData'))
  osf_download(osffiles[fid,],datadir,progress=TRUE)
}
...
if (!file.exists(paste0(datadir,'AveragedataLum.RData'))){
  ...
  fid <- which(osffiles$name==paste0('AveragedataLum.RData'))
  osf_download(osffiles[fid,],datadir,progress=TRUE)
}
...
if (!file.exists(paste0(datadir,'AveragedataLM.RData'))){
  ...
  fid <- which(osffiles$name==paste0('AveragedataLM.RData'))
  osf_download(osffiles[fid,],datadir,progress=TRUE)
}
...
if (!file.exists(paste0(datadir,'AveragedataMel.RData'))){
  ...
  fid <- which(osffiles$name==paste0('AveragedataMel.RData'))
  osf_download(osffiles[fid,],datadir,progress=TRUE)
}
...
if (!file.exists(paste0(datadir,'AveragedataS.RData'))){
  ...
  fid <- which(osffiles$name==paste0('AveragedataS.RData'))
  osf_download(osffiles[fid,],datadir,progress=TRUE)
}

contrastsfinedB <- 2:40

pdf(paste0(figdir,"FirstHarmonic.pdf"), bg="transparent", height = 8, width = 24)

layout(matrix(c(1,2,5,5,6,7,3,4,5,5,8,9),2,6,byrow=TRUE)) 
par(mar=c(3,6,2,1))
...
pdf(paste0(figdir,"SecondHarmonic.pdf"), bg="transparent", height = 8, width = 24)
...
```{r SecondHarmonicPlots, fig.cap="Responses at the second harmonic frequencies (1Hz and 0.8Hz), in the same format as Figure 2.", fig.align="center", echo=FALSE}
